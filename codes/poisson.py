...
python poisson.py airfoil.txt saida.vtk 100 '' '' '0.5,0.5' '' '0.00006' '' '20' '' '0.0006' '' '20'
	...
	a_xis = [5] if len(sys.argv) < 8 else str_to_float_list(sys.argv[7])
	b_xis = [5] if len(sys.argv) < 9 else str_to_float_list(sys.argv[8])
	c_xis = [5] if len(sys.argv) < 10 else str_to_float_list(sys.argv[9])
	d_xis = [5] if len(sys.argv) < 11 else str_to_float_list(sys.argv[10])

	a_etas = [5] if len(sys.argv) < 12 else str_to_float_list(sys.argv[11])
	b_etas = [5] if len(sys.argv) < 13 else str_to_float_list(sys.argv[12])
	c_etas = [5] if len(sys.argv) < 14 else str_to_float_list(sys.argv[13])
	d_etas = [5] if len(sys.argv) < 15 else str_to_float_list(sys.argv[14])
